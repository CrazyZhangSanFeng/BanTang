...
import SwiftyJSON
    ...
    class BTListViewController: UITableViewController {
        ...
        lazy var leftButton: UIButton = {
            ...
            leftButton.addTarget(self, action: #selector(BTListViewController.clickLeft), forControlEvents: .TouchUpInside)
        ...
        override func viewDidLoad() {
            ...
            //添加左侧关注按钮
            navigationItem.leftBarButtonItem = UIBarButtonItem(image: UIImage(named: "discovey_pop_btn_20x20_"), highlightImage: UIImage(named: "discovey_pop_press_btn_20x20_"), target: self, action: #selector(BTListViewController.attentation))
            
            //添加右侧创建按钮
            navigationItem.rightBarButtonItem = UIBarButtonItem(image: UIImage(named: "discover_write_article_icon_18x20_"), highlightImage: UIImage(named: "discover_write_article_highlisht_icon_19x20_"), target: self, action: #selector(BTListViewController.creatText))
